...
namespace Nutrinometer
{
    internal class Database
    {
        ...
        public bool AuthenticateUser(MySqlConnection connection, string username, string password)
        {
        ...
        {
            // Example: Retrieve the username from session or wherever you store it after login
            string loggedInUsername = ""; // Initialize with default value or get from session

            // Example: If you store the username in a session variable named "LoggedInUsername"
            loggedInUsername = HttpContext.Current.Session["LoggedInUsername"] as string;
